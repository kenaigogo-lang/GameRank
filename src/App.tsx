          ...
          <div className="flex w-full flex-col items-end gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            ...
            <div className="flex w-full flex-wrap items-center justify-end gap-2 sm:gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-2 text-[10px] font-medium text-slate-400 hover:text-white bg-slate-800/50 hover:bg-slate-800 rounded-lg transition-all border border-slate-700/50"
              >
